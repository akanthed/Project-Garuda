const nodes = [
  { id: "A", x: 50, y: 50, r: 14, label: "V. Kraus", risk: "high" },
  { id: "B", x: 22, y: 22, r: 8, label: "M. Orlov" },
  { id: "C", x: 82, y: 26, r: 9, label: "S. Deng" },
  { id: "D", x: 18, y: 78, r: 7, label: "Node-9" },
  { id: "E", x: 84, y: 76, r: 10, label: "R. Halim", risk: "med" },
    ...
    <div className="flex flex-col overflow-hidden rounded-xl border border-white/5 bg-card">
      <div className="flex items-center justify-between border-b border-white/5 px-5 py-3">
        <div>
          ...
          <div className="mt-0.5 text-sm font-medium">Cluster · Δ-7</div>
        </div>
      ...
      <div className="relative flex-1">
        <svg viewBox="0 0 100 100" className="h-full w-full" preserveAspectRatio="none">
          ...
          {nodes.map((n) => {
            const color =
              n.risk === "high" ? "var(--danger)" : n.risk === "med" ? "var(--warning)" : "var(--electric)";
            return (
              <g key={n.id}>
